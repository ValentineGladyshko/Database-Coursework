...
namespace Coursework.Controllers
{
    public class RoutesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RouteID,Name,State,AlpinistBaseID")] Routes routes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RouteID,Name,State,AlpinistBaseID")] Routes routes)
        {
            if (ModelState.IsValid)
            {

    ...
    public class AdministratingController : Controller
    {
        ...
        public ActionResult GenerateAlpinists([Bind(Include = "ID")] MyInt myInt)
        {
            if (ModelState.IsValid && myInt.ID > 0 && myInt.ID < 100000)
            {
                ...
                string[] FemaleSur = new string[] { "Шеркова", "Кондратова", "Гусєва", "Близнюк", "Машаріна", "Курзибова", "Куклева", "Снеткова", "Баришнікова", "Родзянко", "Зощенко", "Ковригіна", "Капітанчук", "ЯДРИХИНСЬКИЙ", "Вітюгова", "Триндіна", "Дарюшіна", "Грехова", "Амбражевіч", "Баязова", "Путилова", "Меркушева", "Бакшаева", "Есаулова", "Крестьянінова", "Саракаева", "Кандинський", "Колбіна", "Углицький", "Мороцкая", "Остап'юк", "Пічушкіна", "Салтанова", "Карташова", "Дороніна", "Конак", "Ільїна", "Задорожна", "Бруєвича", "Нотович", "Сайтахметова", "Грушецька", "Шамякіна", "Форопонова", "Соніна", "Мілова", "Ярощука", "Крижова", "Яушкіна", "Тихомирова", "Корнєєва", "Кичеєво", "Вінтухова", "Ананьєва", "Дябіна", "Бобра", "Дуранічева", "Алієва", "Белібердіева", "Ягофарова", "Селезньова", "Мельник", "Солдатова", "Есце", "Шкуратова", "Ісмайлова", "Маркелова", "Ликова", "Баренцева", "Авдієнко", "Іонова", "Батрутдінова", "Жукова", "Янчуковская", "Воробйова", "Махнер", "Золотова", "Калініна", "Грекова", "Игошина", "Хомколова", "Салагіна", "Ізотова", "Куняєва", "Воскобойникова", "Шикалова", "Помелова", "Горбункова", "Сіянцева", "Стегнова", "Варенникова", "Фотина", "Воропаєва", "Піменова", "Саламатова", "Симакина", "Талалихіна", "Килимник", "Завразіна", "Лещев", "Чернікова", "Корчагіна", "Кураєва", "Шімякіна", "Сапожнікова", "Хамідулліна", "Шарудячи", "Браславець", "Якутіна", "Нутріхіна", "Тредіаковський", "Акулова", "Михайличенко", "Трофимова", "Леонова", "Якушкіна", "Соломінцева", "Буднікова", "Мухіна", "Домишева", "Катеріночкіна", "Ухтомський", "Яйцеві", "Сіяніна", "Рибакова", "Сіяновіча", "Зубова", "Кушкіна", "Килина", "Колесникова", "Арсеньєва", "Сіянчук", "Машкова", "Шашлова", "Шеломова", "Яблокова", "Лапаева", "Усачова", "Касьянова", "Черкашина", "Кошкова", "Гурина", "Дідова", "Гаголіна", "Лозанова", "Ярова", "Гібазова", "Сінеокова", "Єрохіна", "Кобзєва", "Яльцева", "Твардовська", "Богатирьова", "Борхеса", "Нікологорская", "Полухина", "Мінаєва", "Варфоломєєва", "Ясінська", "Самаріна", "Кравчікова", "Сальникова", "Інькова", "Ястребенецький", "Степанова", "Манторова", "Жічкіна", "Сафронова", "Ивкина", "Лавлинский", "Лілова", "Єремєєва", "Прилуцька", "Ялунін", "Якимович", "Натарова", "Бабишева", "Механтьева", "Вердеревський", "Перфільева", "Ямбаева", "Дудник", "Фурікова", "Будаева", "Оскорбіна", "Боброва", "Глоба", "Семенова", "Разудалова", "Шитова", "Спірьянова", "Кудайбергенова", "Колобова", "Мартюшова", "Козлакова", "Ягафарова", "Серікова", "Казанець", "Вельямінова", "Онипченко", "Лобана", "Байдавлетова", "Лелух", "Ємельянова", "Кодіца", "Кобякова", "Ягренева", "Убиш", "Язькова", "Курчатова", "Балинська", "Конєва", "Глухова", "Францева", "Горбачова", "Ярустовская", "Поліванова", "Шепелєва", "Ярная", "Цвєткова", "Гордєєва", "Усоева", "Ястржембський", "Комбарова", "Труш", "Корнілова", "Баликова", "Яброва", "Сорокіна", "Лобанова", "Шульга", "Шибалова", "Білоконь", "Рябоконь", "Платущіхіна", "Чюлічкова", "Петрова", "Сайбаталова", "Шіхіріна", "Венедиктова", "Сотникова", "Кулешова", "Добриніна", "Ульянова", "Аллілуєва", "Малець", "Терехова", "Фролова", "Козлова", "Козар", "Балдагуева", "Казнова", "Мяукіна", "Шишлова", "Гарифуллина", "Добролюбова", "Мухоморова", "Колодезева", "Капилюшная", "Ігнатенко", "Машир", "Позднякова", "Боярова", "Авдонина", "Ящук", "Курепін", "Куришіна", "Сотова", "Оленева", "Якубова", "Ритова", "Малюгина", "Купревіча", "Гурковская", "Худовекова", "Пистогова", "Божко", "Щітта", "Ліснича", "Етуша", "Скуратова", "Кратенко", "Кабінова", "Давидкин", "Бєломєстнова", "Яшкін", "Олейникова", "Русанова", "Ягубская", "Якуніна", "Вахрушева", "Кулигіна", "Сабанцева", "Половова", "Тьомкіна", "Куваєва", "Челомей", "Бандуркин", "Пода", "Безфамільна", "Поветнікова", "Домаш", "Чернієнко", "Северинова", "Челомцева", "Капшукова", "Яненко", "Мукосеева", "Кабалкина", "Бушуєва", "Храмова", "Купревіч", "Полигалова", "Ельмпт", "Власова", "Фастер", "Бутиліна", "Слукину", "Перевёртова", "Исламова", "Роговська", "Уіцкая", "Ярославцева", "Коновалова", "Лосівський", "Янкевич", "Антоновича", "Яковець", "Горшкова", "Ентіна", "Ажікелямова", "Нізовкін", "Мартинова", "Ячевская", "Желєзнова", "Пожарська", "Цельнер", "Чемериса", "Заседателева", "Ломтева", "Шепкіна", "Емських", "Кувшинова", "Уланова", "Муленко", "Мосенцова", "Гаранина", "Зінов'єва", "Нємцова", "Чіркаш", "Яніцький", "Моряева", "Сарана", "Колонтаєво", "Цекало", "Астредінова", "Гризлова", "Овчинникова", "Яржемковская", "Тімашева", "Осокіна", "Мясникова", "Черенчікова", "Толбугіна", "Теплякова", "Жванець", "Маматова", "Федорова", "Вікаріева", "Дуболазова", "Ярцова", "Казакова", "Каца", "Рощина", "Рагозіна", "Плаксина", "Баришева", "Савкіна", "Бєлікова", "Карюкін", "Набалкіна", "Корбилева", "Тарновецька", "Волинкіна", "Коренева", "Тіпалова", "Полинова", "Чуркіна", "Портнова", "Баринова", "Веточкіна", "Порсева", "Курсаліна", "Бурцева", "Абумайлова", "Аксенчука", "Сергійовича", "Юдіна", "Ярошинська", "Самохіна", "Бугаєва", "Десяткова", "Умаметева", "Шмирёва", "Густокашіна", "Ярикіна", "Каунайте", "Суботіна", "Балаева", "Чічерінова", "Ревягіна", "Веретёнова", "Ясногородська", "Мячина", "Санькова", "Коракова", "Коршикова", "Якшібаева", "Ельчукова", "Яковленко", "Якушкова", "Яблочкина", "Кліменкова", "Безродна", "Гудкова", "Пономарьова", "Циркунова", "Яхина", "Карманова", "Горностаєва", "Оськина", "Сиромятникова", "Маслюк", "Жиганова", "Овощнікова", "Ваніна", "Жутова", "Никанорова", "Ивашева", "Дятлова", "Гріголюка", "Ясинівські", "Андропова", "Коваль", "Петрищева", "Жестакова", "Муравйова", "Чігракова", "Деревскова", "Задорнова", "Петрухіна", "Шурдук", "Новицька", "Сіялова", "Пьянкова", "Кузіна", "Лебедєва", "Чулічкова", "Нікерова", "Яцковська", "Гика", "Місяць", "Балабанова", "Абоймова", "Гаврилова", "Єжова", "Звягіна", "Салькова", "Давидова", "Реутова", "Бітнера", "Миколаївська", "Аминева", "Милорадова", "Яндарбієва", "Яцкевич", "Пермінова", "Бендліна", "Каравашкіна", "Чегодаєва", "Куксюка", "Шіхранова", "Нужнова", "Нирцева", "Сіянскіха", "Кошечкіна", "Лашкина", "Ануфрієва", "Камкина", "Цуцкова", "Кручинина", "Славакова", "Калнберзін", "Дорохіна", "Бура", "Яцкова", "Умская", "Кувикіна", "Розанова", "Углічініна" }; 
